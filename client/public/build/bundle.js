...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "text-blue-600");
    			add_location(h2, file, 18, 4, 491);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*folderName*/ 1) set_data_dev(t1, /*folderName*/ ctx[0]);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	let if_block = /*folderName*/ ctx[0] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "text-blue-600 svelte-qin9a4");
    			add_location(h1, file, 12, 4, 241);
    			attr_dev(input, "placeholder", "Enter a local directory name");
    			attr_dev(input, "class", "w-5/6");
    			add_location(input, file, 14, 8, 324);
    			attr_dev(button, "class", "w-1/6");
    			add_location(button, file, 15, 8, 422);
    			attr_dev(form, "class", "flex");
    			add_location(form, file, 13, 4, 296);
    			attr_dev(div, "class", "container mx-auto px-8");
    			add_location(div, file, 11, 4, 200);
    			attr_dev(main, "class", "svelte-qin9a4");
    			add_location(main, file, 10, 0, 189);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Tailwind, folderName });
    	...
    	return [folderName, input_input_handler];
    }
