...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 37, 4, 1773);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "text-blue-600");
    			add_location(h1, file, 31, 8, 1331);
    			input.required = true;
    			attr_dev(input, "placeholder", "Enter a local directory name");
    			attr_dev(input, "class", "w-full");
    			add_location(input, file, 33, 16, 1482);
    			attr_dev(div, "class", "container mx-auto px-8");
    			add_location(div, file, 30, 4, 1286);
    			add_location(main, file, 29, 0, 1275);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input, "change", prevent_default(/*onFolderChange*/ ctx[1]), false, true, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("directories" in $$props) directories = $$props.directories;
    	...
    	return [folderName, onFolderChange, input_input_handler];
    }
