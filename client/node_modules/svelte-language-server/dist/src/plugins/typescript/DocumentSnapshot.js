...
(function (DocumentSnapshot) {
    ...
    function fromDocument(document, options) {
        const { tsxMap, text, parserError, nrPrependedLines, scriptKind } = preprocessSvelteFile(document, options);
        return new SvelteDocumentSnapshot(document, parserError, scriptKind, text, nrPrependedLines, tsxMap);
    }
...
class SvelteDocumentSnapshot {
    constructor(parent, parserError, scriptKind, text, nrPrependedLines, tsxMap) {
        this.parent = parent;
